...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  if(confirm){
    try{
      ...
      if(e.code=="requires-recent-login"){
        bool result = await Navigator.push(context, CupertinoPageRoute(builder: (_)=>LoginScreen()));
        if(result){
          deleteAccount();
        }
      }
  ...
  Future<String>createAlertDialog(String title)async{
    String name;
    String toReturn = await showCupertinoDialog(context: context,
              ...
              children: <Widget>[
                ...
                ListTile(
                  ...
                  onTap: FirebaseAuth.instance.currentUser == null ? ()async{
                    await Navigator.push(context, CupertinoPageRoute(builder: (_)=>LoginScreen()));
                    setState(() {
                    });
                  } : ()async{
                    showCupertinoModalPopup(context: context, builder: (_)=>CupertinoActionSheet(
                      ...
                      actions: [
                        CupertinoActionSheetAction(onPressed: ()async{
                          User user = FirebaseAuth.instance.currentUser;
                          Navigator.pop(context);
                          showCupertinoModalPopup(context: context, builder: (_)=>Material(
                            child: Container(
                              color: Colors.white,
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    InfoColumn(
                                      ...
                                      onTap: ()async{
                                        ...
                                        showCupertinoDialog(context: context, builder: (_)=>CupertinoAlertDialog(
                                          ...
                                          actions: [
                                            CupertinoDialogAction(child: Text("Muuda"), onPressed: ()async{
                                    ...
                                    InfoColumn(info: "e-post", data: FirebaseAuth.instance.currentUser.email,onTap: ()async{
                                      Navigator.pop(context);
                                      String newEmail;
                                      showCupertinoDialog(barrierDismissible: true, context: context, builder: (_)=>CupertinoAlertDialog(
                                        title: Text("Uuenda e-posti aadressi"),
                                        content: CupertinoTextField(
                                          autocorrect: false,
                                          placeholder: "Uus e-posti aadress",
                                          onChanged: (val){
                                            newEmail = val;
                                          },
                                        ),
                                        actions: [
                                          CupertinoDialogAction(child: Text("Uuenda"), onPressed: ()async{
                        ...
                        }, child: Text("Logi välja"), isDestructiveAction: true,),
                ...
                ListTile(
                  ...
                  leading: FaIcon(FontAwesomeIcons.appStore, color: Colors.blue,),
                  onTap: ()async{
                    ...
                    showCupertinoModalPopup(context: context, builder: (_)=>CupertinoActionSheet(
                      ...
                      actions: [
                        CupertinoActionSheetAction(
                          ...
                          onPressed: (){
                            Navigator.push(context, CupertinoPageRoute(builder: (_)=>AddDataMap()));
                          },
                        ),
                        CupertinoActionSheetAction(
                          child: Text("Lisa olemasolevale väljakule augukoordinaadid"),
                          onPressed: (){
                            Navigator.push(context, CupertinoPageRoute(builder: (_)=>AddDataCoordinates()));
                          },
                        ),
                      ],
                    ));
                ...
                ListTile(
                  ...
                  onTap: (){
                    showCupertinoModalPopup(context: context, builder: (_)=>CupertinoActionSheet(
                      title: Text("Lähtesta kõik andmed?"),
                      message: Text("See tegevus on tagasivõtmatu. Kas minna edasi?"),
                      actions: [
                        CupertinoActionSheetAction(
                          child: Text("Kustuta kõik andmed", style: TextStyle(color: Colors.red),),
                          onPressed: ()async{
                            await FirebaseAuth.instance.signOut();
                      ...
                      cancelButton: CupertinoActionSheetAction(child: Text("Tagasi"), onPressed: (){Navigator.pop(context);},),
                    ));
                  },
                ),
              ],
