                ...
                IconButton(
                  ...
                  onPressed: (){
                    showDialog(context: context, builder: (_)=>AlertDialog(
                      title: Text("Kustuta?"),
                      content: Text("Kas soovid selle ringi kustutada?\n${savedRounds[howMany]}\n${totalScore.toString()} lööki"),
                      actions: [
                        MaterialButton(
                          child: Text("Tagasi"),
                ...
                if(user == null){
                  ...
                  showDialog(context: context, builder: (_)=>AlertDialog(
                    ...
                    actions: [
                      ...
                      MaterialButton(
                        child: Text("Vali ringid", style: TextStyle(fontWeight: FontWeight.bold),),
                        onPressed: ()async{
                          print(FirebaseAuth.instance.currentUser);
                          bool sync = await Navigator.push(context, MaterialPageRoute(builder: (_)=>SelectRoundsFromCloudScreen())) ?? false;
                          if(sync){
                            setState(() {
                              getListViewChildren();
                            });
                    ...
                    onTap: ()async{
                      ...
                      if(await dataUploaded()){
                        ...
                        showDialog(context: context, builder: (_)=>AlertDialog(
                          ...
                          actions: [
                            MaterialButton(child: Text("Tagasi"), onPressed: (){Navigator.pop(context);},),
                            MaterialButton(child: Text("Jätka ikkagi", style: TextStyle(color: Colors.red),), onPressed: (){continueAnyway = true; Navigator.pop(context);},)
                          ],
                        ));
                      }
                      if(continueAnyway){
                      ...
                      content: Text("Sisselogitud kasutajad saavad need ja kõik järgnevad ringid oma kontoga siduda."),
                      actions: [
                      MaterialButton(
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (_)=>LoginScreen(linkRoundsAfterLogin: true,)));
                      }else{
