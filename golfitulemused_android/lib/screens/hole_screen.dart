          ...
          builder: (context) => AlertDialog(
            ...
            actions: <Widget>[
              ...
              MaterialButton(
                ...
                child: new Text('Jah, tahan lõpetada', style: TextStyle(color: Colors.red),),
              ),
            ],
          ),
        )) ??
                            ...
                            children: <Widget>[
                              ...
                              Visibility(
                                ...
                                child: IconButton(icon: Icon(Icons.exit_to_app, color: Colors.white, size: 30,),onPressed: ()async{
                                  String shouldContinue = await showDialog(context: context,
                                      builder: (context)=>AlertDialog(
                                        title: Text("Lõpetad ringi?"),
                                        content: Text("Kas oled kindel, et tahad ringi lõpetada?"),
                                        actions: <Widget>[
                                          MaterialButton(onPressed: (){Navigator.pop(context, "save");}, child: Text("Lõpeta ja salvesta")),
                                          MaterialButton(onPressed: (){Navigator.pop(context, "delete");}, child: Text("Lõpeta ja kustuta", style: TextStyle(color: Colors.red),)),
                                        ],
                                      )
                                  );
                                  if(shouldContinue == "save"){
                                    ...
                                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (_)=>BottomNavigationScreen(false)));
                                  }
                                },),
                              ),
                            ],
